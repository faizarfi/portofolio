...
export const LANGUAGES: LanguageItem[] = [
  ...
  { code: "th", name: "Thai", nativeName: "ภาษาไทย", flag: "🇹🇭", popular: true },
  { code: "ms", name: "Malay", nativeName: "Bahasa Melayu", flag: "🇲🇾", popular: true },
  { code: "hi", name: "Hindi", nativeName: "हिन्दी", flag: "🇮🇳", popular: true },
  { code: "jw", name: "Javanese", nativeName: "Basa Jawa", flag: "🇮🇩", popular: true },
  { code: "su", name: "Sundanese", nativeName: "Basa Sunda", flag: "🇮🇩", popular: true },
