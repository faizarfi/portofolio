  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        iconSvg: (
          <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-slate-100 text-slate-800 font-mono font-bold text-[11px]">
            TS
          </div>
        ),
      },
              ...
              <div className="neat-card flex h-full flex-col justify-between p-4 sm:p-5">
                <div>
                  ...
                  <div className="mb-3.5 flex items-center justify-between border-b border-slate-100 pb-2.5">
                    ...
                    <span className="font-mono text-xs font-bold text-slate-400">{cat.number}</span>
                  </div>
                  ...
                  <div className="space-y-2">
                    {cat.items.map((item) => (
                      <div
                        key={item.name}
                        className="group flex items-center justify-between gap-2.5 rounded-lg border border-slate-200/70 bg-slate-50/50 p-2.5 transition-colors hover:border-slate-300 hover:bg-white"
                      >
                            ...
                            <div className="flex items-center gap-2">
                              {item.url ? (
                                <a
                                  ...
                                  className="text-xs font-bold text-slate-900 transition-colors hover:underline truncate"
                                >
                                  {item.name}
                                </a>
                              ) : (
                        ...
                        {/* Version Badge */}
                        {item.version && (
                          <span className="shrink-0 rounded border border-slate-200 bg-white px-1.5 py-0.5 font-mono text-[10px] font-bold text-slate-600">
                            {item.version}
                          </span>
                        )}
                      </div>
