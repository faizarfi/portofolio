...
const CORE_TECH_STACK: TechCategory[] = [
  {
    ...
    subtitle: "Arsitektur server, API & database",
    items: [
      {
        name: "Laravel",
        version: "11.x",
        desc: "Framework PHP, Eloquent ORM, REST API",
        url: "https://laravel.com",
        iconSvg: (
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-rose-50 text-[#FF2D20] shadow-2xs">
      ...
      },
      {
        name: "PHP",
        version: "8.2+",
        desc: "OOP Modern, MVC, Clean Architecture",
        url: "https://www.php.net",
        iconSvg: (
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-indigo-50 text-[#777BB4] shadow-2xs">
      ...
      },
      {
        name: "MySQL",
        version: "8.0",
        desc: "Relasional DB, Indexing & phpMyAdmin",
        url: "https://www.mysql.com",
        iconSvg: (
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-sky-50 text-[#00758F] shadow-2xs">
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: "Tailwind CSS",
        version: "v4.2",
        desc: "Utility-First, Responsif di HP & Desktop",
        url: "https://tailwindcss.com",
        iconSvg: (
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-sky-50 text-[#06B6D4] shadow-2xs">
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
      ...
      },
      {
        name: "TypeScript",
        version: "5.x",
        desc: "Type Safety, Clean & Moduler Code",
        url: "https://www.typescriptlang.org",
        iconSvg: (
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#3178C6]/15 text-[#3178C6] font-mono font-bold text-[11px] shadow-2xs">
            TS
          </div>
        ),
      },
  ...
  {
    title: "Alat, Ikon & IT Support",
    subtitle: "Tooling, font ikon & bantuan teknis",
    items: [
      {
        name: "Git & GitHub",
        desc: "Version Control & Source Code Repository",
        url: "https://github.com/faizarfi",
        iconSvg: (
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-orange-50 text-[#F05032] shadow-2xs">
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
      ...
      },
      {
        name: "Lucide",
        version: "v1.7",
        desc: "Font Ikon Vektor & Visual Elegan",
      ...
      },
      {
        ...
        desc: "Troubleshooting OS/Hardware & Jaringan LAN",
        iconSvg: (
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-blue-50 text-blue-600 shadow-2xs">
      ...
      <div className="mx-auto max-w-7xl">
        <Reveal direction="up">
          <SectionHeading
            ...
            subtitle="Teknologi utama yang saya kuasai dan gunakan secara aktif untuk membangun aplikasi web, sistem informasi, dan dukungan teknis IT."
          />
        </Reveal>

        {/* ── Focused 3-Card Responsive Grid (1 col on mobile, 3 cols on desktop) ── */}
                ...
                <div>
                  ...
                  <div className="space-y-2.5">
                    {cat.items.map((item) => (
                      <div
                        key={item.name}
                        className="group flex items-center justify-between gap-2.5 rounded-xl border border-slate-100 bg-slate-50/70 p-2.5 transition-all duration-200 hover:-translate-y-0.5 hover:border-blue-200 hover:bg-blue-50/40 hover:shadow-xs"
                      >
                        ...
                        {/* Version Badge */}
                        {item.version && (
                          <span className="shrink-0 rounded-md border border-slate-200/80 bg-white px-2 py-0.5 font-mono text-[10px] font-bold text-slate-600 shadow-2xs">
                            {item.version}
                          </span>
                        )}
                      </div>
